...
## 10. Solicitacoes internas

O botao "Pedido de Conta" da tela de login e a pagina Solicitações registram pedidos na colecao `accountRequests`. DONO e DEV acompanham a caixa de solicitacoes, atendem, rejeitam, transferem, concluem, reativam e mantem historico interno por solicitacao. O fluxo atual usa apenas notificacoes internas do sistema.
