...
export function buildProposalPayload(form = {}, snapshot) {
  ...
  return {
    ...
    notes: form.generalNotes || form.proposalText || machine?.defaultProposalText || machine?.description || "",
    paymentTerms: form.paymentTerms,
    productOverrides: form.productOverrides || {},
    proposalText: form.proposalText || machine?.defaultProposalText || machine?.description || "",
