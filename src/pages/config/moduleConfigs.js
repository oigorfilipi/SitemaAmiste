...
export const moduleConfigs = {
  machines: {
    ...
    fields: [
      ...
      { name: "imageDataUrl", label: "Upload de imagem", type: "imageUpload", full: true, section: sections.operation, fallbackUrlField: "imageUrl", previewVariant: "catalog" },
      ...
      {
        name: "modelVariantCount",
        label: "Quantos modelos/versoes?",
        type: "number",
        defaultValue: (_snapshot, editingRecord) => editingRecord?.modelVariantCount || editingRecord?.modelVariants?.length || 0,
        min: 0,
        max: 50,
        section: sections.operation,
        visibleWhen: (data) => data.hasModelVariants,
        helpText: "Ao informar a quantidade, o sistema abre uma pagina de preenchimento para cada versao.",
      },
      { name: "modelVariants", label: "Paginas dos modelos/versoes", type: "variantList", full: true, countField: "modelVariantCount", defaultValue: [], section: sections.operation, visibleWhen: (data) => data.hasModelVariants },
