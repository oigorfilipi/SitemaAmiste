    ...
    <section className="overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-sm">
      <div className="overflow-x-auto">
        <div className="min-w-[1020px]">
          <div className="grid grid-cols-[1.3fr_1fr_1fr_145px_150px_155px_80px] gap-4 border-b border-zinc-100 bg-zinc-50/70 px-4 py-3 text-xs font-black uppercase text-amiste-gray/60">
            <span>Cliente</span>
            <span>Contato</span>
            <span>Contrato</span>
            <span>Maquina</span>
          ...
          {rows.map((client) => (
            <div
              className={cn(
                "grid w-full cursor-pointer grid-cols-[1.3fr_1fr_1fr_145px_150px_155px_80px] items-center gap-4 border-b border-zinc-100 px-4 py-4 text-left transition last:border-b-0 hover:bg-amiste-red/5",
